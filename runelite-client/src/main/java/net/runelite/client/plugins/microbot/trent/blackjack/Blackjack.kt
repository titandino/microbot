            ...
            "BLACKJACK" -> {
                ...
                if (BLACKJACK_CYCLE <= 2) {
                    ...
                    if ((PREVIOUS_ACTION_TIME + 1140 + PICKPOCKET_MIN_DELAY) > System.currentTimeMillis()) {
                        val time = ((PREVIOUS_ACTION_TIME + 840 + Rs2Random.between(PICKPOCKET_MIN_DELAY, PICKPOCKET_MAX_DELAY)) - System.currentTimeMillis()).toInt()
...
fun handlePlayerHit(client: Client, npc: NPC) {
    if (PLAYER_HIT >= 1) {
        ...
        var c = Rs2Random.between(123, 130)
