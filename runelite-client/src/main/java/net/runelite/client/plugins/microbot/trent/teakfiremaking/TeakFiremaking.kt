...
import net.runelite.client.plugins.microbot.trent.ardystalls.ArdougneStallScript
import net.runelite.client.plugins.microbot.trent.ardystalls.THIEVING_TILE
