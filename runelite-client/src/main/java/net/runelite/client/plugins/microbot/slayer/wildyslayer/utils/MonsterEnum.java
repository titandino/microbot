...
public enum MonsterEnum {
    ...
    DUST_DEVILS("Dust Devils", "Dust devil", false, new WorldPoint(3439, 10124, 0), Prayer.PROTECT_MELEE, false, true, null, Direction.EAST),
    MAMMOTH("Mammoths", "Mammoth", false, new WorldPoint(3165, 3597, 0), Prayer.PROTECT_MELEE, true, false, new WorldPoint(3218, 3594, 0), Direction.EAST),
